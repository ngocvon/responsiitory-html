...
function charMc(){
    ...
    $('#container').highcharts({
        ...
        tooltip: {
            ...
            //borderColor: '#19648f',
            boxShadowX:'-20px #b5b5b5',
            boxShadowY:'-20px #b5b5b5',
            boxShadowBlur:'-20px #b5b5b5',
            borderRadius:0,
            borderWidth: 2,
            formatter: function() {
...
var click_show_hide = function () {
	
	var body = $("html, body");
	
    $("a.aleft").click(function(){
		//$("html, body").animate({scrollTop:0}, 'slow');
		
       $('.formcontactus').animate({'top':'10%'},600);
       var checkDisplay=$('.formcontactus').css('display');
       if(checkDisplay=='block'){
           $("body").append("<div class='overlays'><a href='javascript:close_dropprofile()'></a></div>");
        }
    })
	$("p.pleft").click(function(){
		return false;
	})	
};
